// Copyright 2023 (c) Andreas Kr�mer, basyskom GmbH - Germany
//
...
export const createWoodWorkingFullLogic = async (addressSpace: AddressSpace): Promise<void> => {
    ...
    flLocationGpsNode?.setValueFromSource({ dataType: DataType.String, value: "S3351'25.07\", E15112'54.57\"" });
    ...
    // Set the identification values for full woodworking companion specification
